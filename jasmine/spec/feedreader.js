...
$(function() {
    ...
    */
    describe('RSS Feeds', function() {
         ...
         */
         //for loops through all the feeds from 0 to length-1 and expects url to be defined
    ...
    describe('New Feed Selection', function(){
         ...
         */
          //prevcontent is loaded with the feed that is already loaded
          prevcontent = $('.feed');
          ...
          it('content changes when a new feed is loaded', function(done) {
            window.loadFeed(1, function() {
              expect($('.feed') !== prevcontent).toBeTruthy();
              done();
            });
          });
    });
